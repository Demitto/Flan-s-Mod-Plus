...
public class MwGui extends GuiScreen {
    ...
    protected void keyTyped(char c, int key) {
		...
		case Keyboard.KEY_B:
			int mx = this.mouseBlockX;
			int my = (this.mouseBlockY > 0) ? this.mouseBlockY : this.mw.defaultTeleportHeight;
			int mz = this.mouseBlockZ;
			new MwGuiPositionDialog(
				this,
				this.mw,
				this.mapView,
				mx,
			...
			MwUtil.printBoth("set Impact Position :"+mx+","+my+","+mz);
