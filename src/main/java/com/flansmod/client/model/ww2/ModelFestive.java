...
// Model: 
// Model Creator: 
// Created on: 15.06.2015 - 21:34:44
// Last changed on: 15.06.2015 - 21:34:44
...
public class ModelFestive extends ModelVehicle //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelFestive() //Same as Filename
	{
		...
		bodyModel[284] = new ModelRendererTurbo(this, 0, 355, textureX, textureY); // Box 4
		bodyModel[285] = new ModelRendererTurbo(this, 36, 385, textureX, textureY); // Box 5
		bodyModel[286] = new ModelRendererTurbo(this, 36, 351, textureX, textureY); // Box 6
		bodyModel[287] = new ModelRendererTurbo(this, 0, 355, textureX, textureY); // Box 7
		bodyModel[288] = new ModelRendererTurbo(this, 0, 355, textureX, textureY); // Box 8
		bodyModel[289] = new ModelRendererTurbo(this, 0, 380, textureX, textureY); // Box 9
		bodyModel[290] = new ModelRendererTurbo(this, 0, 380, textureX, textureY); // Box 10
		bodyModel[291] = new ModelRendererTurbo(this, 0, 359, textureX, textureY); // Box 11
		bodyModel[292] = new ModelRendererTurbo(this, 0, 403, textureX, textureY); // Box 12
		bodyModel[293] = new ModelRendererTurbo(this, 0, 361, textureX, textureY); // Box 13
		bodyModel[294] = new ModelRendererTurbo(this, 0, 361, textureX, textureY); // Box 14
		...
		bodyModel[284].addShapeBox(-1F, 0F, -15F, 2, 10, 30, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F); // Box 4
		bodyModel[284].setRotationPoint(45F, -8F, 0F);

		bodyModel[285].addShapeBox(0F, 10F, -15F, 2, 3, 30, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F); // Box 5
		bodyModel[285].setRotationPoint(45F, -8F, 0F);

		bodyModel[286].addShapeBox(-1F, -3F, -15F, 2, 3, 30, 0F, -2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 6
		bodyModel[286].setRotationPoint(45F, -8F, 0F);

		bodyModel[287].addBox(-0.25F, -0.8F, -0.25F, 7, 1, 1, 0F); // Box 7
		bodyModel[287].setRotationPoint(39F, -11F, 6.25F);
		bodyModel[287].rotateAngleZ = -0.36651914F;

		bodyModel[288].addBox(-0.25F, -0.8F, -0.75F, 7, 1, 1, 0F); // Box 8
		bodyModel[288].setRotationPoint(39F, -11F, -6.25F);
		bodyModel[288].rotateAngleZ = -0.36651914F;

		bodyModel[289].addBox(0F, 0F, -0.5F, 7, 2, 2, 0F); // Box 9
		bodyModel[289].setRotationPoint(39F, -2F, 10F);
		bodyModel[289].rotateAngleZ = -0.12217305F;

		bodyModel[290].addBox(0F, 0F, -1.5F, 7, 2, 2, 0F); // Box 10
		bodyModel[290].setRotationPoint(39F, -2F, -10F);
		bodyModel[290].rotateAngleZ = -0.12217305F;

		bodyModel[291].addBox(-0.25F, -0.8F, 0.25F, 1, 1, 12, 0F); // Box 11
		bodyModel[291].setRotationPoint(39F, -11F, -6.25F);
		bodyModel[291].rotateAngleZ = -0.36651914F;

		bodyModel[292].addBox(2F, 0F, -19.5F, 2, 2, 19, 0F); // Box 12
		bodyModel[292].setRotationPoint(39F, -2F, 10F);
		bodyModel[292].rotateAngleZ = -0.12217305F;

		bodyModel[293].addBox(5.75F, 0.2F, -0.25F, 1, 8, 1, 0F); // Box 13
		bodyModel[293].setRotationPoint(39F, -11F, 6.25F);
		bodyModel[293].rotateAngleZ = -0.36651914F;

		bodyModel[294].addBox(5.75F, 0.2F, -0.75F, 1, 8, 1, 0F); // Box 14
		bodyModel[294].setRotationPoint(39F, -11F, -6.25F);
		...
		turretModel[124] = new ModelRendererTurbo(this, 0, 287, textureX, textureY); // Box 509
		turretModel[125] = new ModelRendererTurbo(this, 0, 310, textureX, textureY); // Box 510
		turretModel[126] = new ModelRendererTurbo(this, 58, 302, textureX, textureY); // Box 0
		turretModel[127] = new ModelRendererTurbo(this, 13, 338, textureX, textureY); // Box 1
		turretModel[128] = new ModelRendererTurbo(this, 62, 323, textureX, textureY); // Box 2
		turretModel[129] = new ModelRendererTurbo(this, 62, 335, textureX, textureY); // Box 3
		...
		turretModel[124].addBox(-6F, -6F, -14.5F, 16, 3, 16, 0F); // Box 509
		turretModel[124].setRotationPoint(3F, -29.5F, 0F);
		turretModel[124].rotateAngleX = 0.06981317F;
		turretModel[124].rotateAngleY = 0.13962634F;
		turretModel[124].rotateAngleZ = -0.06981317F;

		turretModel[125].addShapeBox(-5.5F, -12F, -14F, 15, 6, 15, 0F, -2F, -1F, -2F, -2F, -1F, -2F, -2F, 0F, -2F, -2F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 510
		turretModel[125].setRotationPoint(3F, -29.5F, 0F);
		turretModel[125].rotateAngleX = 0.06981317F;
		turretModel[125].rotateAngleY = 0.13962634F;
		turretModel[125].rotateAngleZ = -0.06981317F;

		turretModel[126].addShapeBox(-3.5F, -19F, -12F, 11, 7, 11, 0F, -1F, -4F, -1F, -5F, -4F, -1F, -7F, 0F, -8F, -1F, 0F, -8F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0
		turretModel[126].setRotationPoint(3F, -29.5F, 0F);
		turretModel[126].rotateAngleX = 0.06981317F;
		turretModel[126].rotateAngleY = 0.13962634F;
		turretModel[126].rotateAngleZ = -0.06981317F;

		turretModel[127].addShapeBox(-1.5F, -16.5F, -18F, 6, 4, 6, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 1
		turretModel[127].setRotationPoint(3F, -29.5F, 0F);
		turretModel[127].rotateAngleX = -0.13962634F;
		turretModel[127].rotateAngleY = 0.12217305F;
		turretModel[127].rotateAngleZ = 0.05235988F;

		turretModel[128].addShapeBox(-1.5F, -17.5F, -18F, 6, 1, 6, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 2
		turretModel[128].setRotationPoint(3F, -29.5F, 0F);
		turretModel[128].rotateAngleX = -0.13962634F;
		turretModel[128].rotateAngleY = 0.12217305F;
		turretModel[128].rotateAngleZ = 0.05235988F;

		turretModel[129].addShapeBox(-1.5F, -12.5F, -18F, 6, 1, 6, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F); // Box 3
		turretModel[129].setRotationPoint(3F, -29.5F, 0F);
		turretModel[129].rotateAngleX = -0.13962634F;
		turretModel[129].rotateAngleY = 0.12217305F;
		turretModel[129].rotateAngleZ = 0.05235988F;


		leftTrackWheelModels = new ModelRendererTurbo[17];
		leftTrackWheelModels[0] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape112
		leftTrackWheelModels[1] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape113
		leftTrackWheelModels[2] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape114
		leftTrackWheelModels[3] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape115
		leftTrackWheelModels[4] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape116
		leftTrackWheelModels[5] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape117
		leftTrackWheelModels[6] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape118
		leftTrackWheelModels[7] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape119
		leftTrackWheelModels[8] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape120
		leftTrackWheelModels[9] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape121
		leftTrackWheelModels[10] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape122
		leftTrackWheelModels[11] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape123
		leftTrackWheelModels[12] = new ModelRendererTurbo(this, 321, 259, textureX, textureY); // Import Shape124
		leftTrackWheelModels[13] = new ModelRendererTurbo(this, 321, 259, textureX, textureY); // Import Shape125
		leftTrackWheelModels[14] = new ModelRendererTurbo(this, 257, 237, textureX, textureY); // Import Shape126
		leftTrackWheelModels[15] = new ModelRendererTurbo(this, 257, 237, textureX, textureY); // Import Shape127
		leftTrackWheelModels[16] = new ModelRendererTurbo(this, 257, 237, textureX, textureY); // Import Shape128
		...
		leftTrackWheelModels[0].setRotationPoint(-49F, 1F, 25.5F);
		...
		leftTrackWheelModels[1].setRotationPoint(-49F, 1F, 20.5F);
		...
		leftTrackWheelModels[14].addShape3D(5F, -3F, -1.5F, new Shape2D(new Coord2D[] { new Coord2D(4, 0, 4, 0), new Coord2D(6, 0, 6, 0), new Coord2D(8, 2, 8, 2), new Coord2D(8, 4, 8, 4), new Coord2D(6, 6, 6, 6), new Coord2D(4, 6, 4, 6), new Coord2D(2, 4, 2, 4), new Coord2D(2, 2, 2, 2) }), 3, 8, 8, 20, 3, ModelRendererTurbo.MR_FRONT, new float[] {3 ,2 ,3 ,2 ,3 ,2 ,3 ,2}); // Import Shape126
		leftTrackWheelModels[14].setRotationPoint(-42F, -7.5F, 19F);

		leftTrackWheelModels[15].addShape3D(5F, -3F, -1.5F, new Shape2D(new Coord2D[] { new Coord2D(4, 0, 4, 0), new Coord2D(6, 0, 6, 0), new Coord2D(8, 2, 8, 2), new Coord2D(8, 4, 8, 4), new Coord2D(6, 6, 6, 6), new Coord2D(4, 6, 4, 6), new Coord2D(2, 4, 2, 4), new Coord2D(2, 2, 2, 2) }), 3, 8, 8, 20, 3, ModelRendererTurbo.MR_FRONT, new float[] {3 ,2 ,3 ,2 ,3 ,2 ,3 ,2}); // Import Shape127
		leftTrackWheelModels[15].setRotationPoint(-13F, -7.5F, 19F);

		leftTrackWheelModels[16].addShape3D(5F, -3F, -1.5F, new Shape2D(new Coord2D[] { new Coord2D(4, 0, 4, 0), new Coord2D(6, 0, 6, 0), new Coord2D(8, 2, 8, 2), new Coord2D(8, 4, 8, 4), new Coord2D(6, 6, 6, 6), new Coord2D(4, 6, 4, 6), new Coord2D(2, 4, 2, 4), new Coord2D(2, 2, 2, 2) }), 3, 8, 8, 20, 3, ModelRendererTurbo.MR_FRONT, new float[] {3 ,2 ,3 ,2 ,3 ,2 ,3 ,2}); // Import Shape128
		leftTrackWheelModels[16].setRotationPoint(14.5F, -7.5F, 19F);


		rightTrackWheelModels = new ModelRendererTurbo[17];
		rightTrackWheelModels[0] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape4
		rightTrackWheelModels[1] = new ModelRendererTurbo(this, 321, 259, textureX, textureY); // Import Shape7
		rightTrackWheelModels[2] = new ModelRendererTurbo(this, 321, 259, textureX, textureY); // Import Shape9
		rightTrackWheelModels[3] = new ModelRendererTurbo(this, 257, 237, textureX, textureY); // Import Shape2
		rightTrackWheelModels[4] = new ModelRendererTurbo(this, 257, 237, textureX, textureY); // Import Shape12
		rightTrackWheelModels[5] = new ModelRendererTurbo(this, 257, 237, textureX, textureY); // Import Shape13
		rightTrackWheelModels[6] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape20
		rightTrackWheelModels[7] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape21
		rightTrackWheelModels[8] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape22
		rightTrackWheelModels[9] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape23
		rightTrackWheelModels[10] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape24
		rightTrackWheelModels[11] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape25
		rightTrackWheelModels[12] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape26
		rightTrackWheelModels[13] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape27
		rightTrackWheelModels[14] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape28
		rightTrackWheelModels[15] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape29
		rightTrackWheelModels[16] = new ModelRendererTurbo(this, 321, 293, textureX, textureY); // Import Shape30
		...
		rightTrackWheelModels[0].setRotationPoint(-49F, 1F, -16F);
		...
		rightTrackWheelModels[6].setRotationPoint(-49F, 1F, -21F);
		...
		fancyTrackModel[0] = new ModelRendererTurbo(this, 0, 455, textureX, textureY); // Box 526
		fancyTrackModel[1] = new ModelRendererTurbo(this, 0, 472, textureX, textureY); // Box 1

		fancyTrackModel[0].addShapeBox(-2.5F, -1F, -5.5F, 4, 1, 11, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 526

		fancyTrackModel[1].addShapeBox(1.5F, -2F, -5F, 1, 2, 10, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 1

		animBarrelModel = new ModelRendererTurbo[14];
		animBarrelModel[0] = new ModelRendererTurbo(this, 113, 113, textureX, textureY); // Box 43
		animBarrelModel[1] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 247
		animBarrelModel[2] = new ModelRendererTurbo(this, 217, 1, textureX, textureY); // Box 245
		animBarrelModel[3] = new ModelRendererTurbo(this, 25, 1, textureX, textureY); // Box 248
		animBarrelModel[4] = new ModelRendererTurbo(this, 233, 1, textureX, textureY); // Box 246
		animBarrelModel[5] = new ModelRendererTurbo(this, 9, 1, textureX, textureY); // Box 242
		animBarrelModel[6] = new ModelRendererTurbo(this, 193, 1, textureX, textureY); // Box 249
		animBarrelModel[7] = new ModelRendererTurbo(this, 33, 1, textureX, textureY); // Box 243
		animBarrelModel[8] = new ModelRendererTurbo(this, 497, 1, textureX, textureY); // Box 250
		animBarrelModel[9] = new ModelRendererTurbo(this, 241, 9, textureX, textureY); // Box 244
		animBarrelModel[10] = new ModelRendererTurbo(this, 1, 17, textureX, textureY); // Box 239
		animBarrelModel[11] = new ModelRendererTurbo(this, 1, 9, textureX, textureY); // Box 238
		animBarrelModel[12] = new ModelRendererTurbo(this, 1, 49, textureX, textureY); // Box 4
		animBarrelModel[13] = new ModelRendererTurbo(this, 25, 9, textureX, textureY); // Box 5

		animBarrelModel[0].addShapeBox(6F, -2.5F, -2.5F, 56, 5, 5, 0F, 0F, -1F, -1F, 0F, -1.3F, -1.3F, 0F, -1.3F, -1.3F, 0F, -1F, -1F, 0F, -1F, -1F, 0F, -1.3F, -1.3F, 0F, -1.3F, -1.3F, 0F, -1F, -1F); // Box 43

		animBarrelModel[1].addShapeBox(69F, -1.5F, 1.5F, 2, 3, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 247

		animBarrelModel[2].addShapeBox(69F, -2.5F, -2.5F, 2, 1, 5, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 245

		animBarrelModel[3].addShapeBox(69F, -1.5F, -2.5F, 2, 3, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 248

		animBarrelModel[4].addShapeBox(69F, 1.5F, -2.5F, 2, 1, 5, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F); // Box 246

		animBarrelModel[5].addShapeBox(66F, -1.5F, 1.5F, 1, 3, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 242

		animBarrelModel[6].addShapeBox(67F, -2.5F, -1.5F, 2, 1, 3, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 249

		animBarrelModel[7].addShapeBox(66F, -1.5F, -2.5F, 1, 3, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 243

		animBarrelModel[8].addShapeBox(67F, 1.5F, -1.5F, 2, 1, 3, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 250

		animBarrelModel[9].addShapeBox(66F, 1.5F, -2.5F, 1, 1, 5, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F); // Box 244

		animBarrelModel[10].addShapeBox(66F, -2.5F, -2.5F, 1, 1, 5, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 239

		animBarrelModel[11].addShapeBox(63F, 1F, -1F, 3, 1, 2, 0F, 0F, -0.2F, 0.5F, 0F, -0.5F, 0.5F, 0F, -0.5F, 0.5F, 0F, -0.2F, 0.5F, 0F, -0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, -0.5F, 0.5F); // Box 238

		animBarrelModel[12].addShapeBox(62F, -2.5F, -2.5F, 1, 5, 5, 0F, 0F, -1.3F, -1.3F, 0F, -1F, -1F, 0F, -1F, -1F, 0F, -1.3F, -1.3F, 0F, -1.3F, -1.3F, 0F, -1F, -1F, 0F, -1F, -1F, 0F, -1.3F, -1.3F); // Box 4

		animBarrelModel[13].addShapeBox(63F, -2F, -1F, 3, 1, 2, 0F, 0F, -0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, 0.5F, 0.5F, 0F, -0.5F, 0.5F, 0F, -0.2F, 0.5F, 0F, -0.5F, 0.5F, 0F, -0.5F, 0.5F, 0F, -0.2F, 0.5F); // Box 5
		...
		barrelAttach = new Vector3f(26F/16F, 26.2F/16F, 0F/16F);
