...
public class ModelLeviathanX extends ModelVehicle //Same as Filename
{
	int textureX = 1024;
	int textureY = 1024;

	public ModelLeviathanX() //Same as Filename
	{
		...
		bodyModel[51] = new ModelRendererTurbo(this, 0, 0, textureX, textureY); // Box 129
		...
		bodyModel[51].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 129
		bodyModel[51].setRotationPoint(67F, -40F, 0F);

		turretModel = new ModelRendererTurbo[1];
		turretModel[0] = new ModelRendererTurbo(this,  0,  0, textureX, textureY); // barrel1		
		turretModel[0].addObj("/FC Pack/assets/flansmod/models/ChimeraTurret.obj");
		turretModel[0].setRotationPoint(25F, 41F, 0F);
		
		barrelModel = new ModelRendererTurbo[1];
		barrelModel[0] = new ModelRendererTurbo(this,  0,  0, textureX, textureY); // barrel1		
		barrelModel[0].addObj("/FC Pack/assets/flansmod/models/ChimeraBarrel.obj");
		barrelModel[0].setRotationPoint(65F, 41F, 0F);
